...
Below is how you can call in the function created on out R script (`almond_yield.R`). Our R script takes in the climate data frame as the input to the function and extracts the useful data from it as part of the model.
