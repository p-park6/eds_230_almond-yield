...
![Almond Yield Model Diagram](Almond_Yield_Model.png){width="800"}
...
The climate data is going to need to be preprocessed becase the the model uses climate data from a particular month, yet we have ALL of the climate measurements for multiple times per day.
